...
int main(int argc, char *argv[])
{
    ...
    #include "createFieldRefs.H"
        //new for Nox calculation
    #include "readCombustionProperties.H"	//////	
    #include "readInitialConditions.H"	//////
    #include "creatingNoxFields.H"		//////
    	//new for soot calculation
    #include "creatingSootFields.H"		//////    
    ...
    while (runTime.run())
    {
        ...
        // new for NOx calculation
	#include "NoxCalculation.H"  			//////
	// new for soot calculation
        #include "SootCalculation.H"			//////	
